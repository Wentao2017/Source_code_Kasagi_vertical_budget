...
!   alsakzt=alsakz; askzt=askz; bskzt=bskz; cskzt=cskz;   !Guo
...
if (istret==0) then                                !Guo
   aamt(1 )=alpha_0+beta_0*(11./6./dy)             !Guo
   aamt(ny)=alpha_n+beta_n*(11./6./dy)             !Guo
else                                               !Guo
   aamt(1 )=alpha_0+beta_0*ppy(1 )*(11./6./dy)     !Guo
   aamt(ny)=alpha_n+beta_n*ppy(ny)*(11./6./dy)     !Guo
endif                                              !Guo
...
if (istret==0) then                              !Guo
   bbmt(1 )=beta_0*(-18./6./dy)                  !Guo
   bbmt(ny)=0.                                   !Guo 
else                                             !Guo
   bbmt(1 )=beta_0*ppy(1)*(-18./6./dy)           !Guo
   bbmt(ny)=0.                                   !Guo
endif                                            !Guo
...
if (istret==0) then                              !Guo
   ccmt(1 )=beta_0*(9./6./dy)                    !Guo
   ccmt(ny)=0.                                   !Guo
else                                             !Guo
   ccmt(1 )=beta_0*ppy(1)*(9./6./dy)             !Guo
   ccmt(ny)=0.                                   !Guo 
endif                                            !Guo
...
if (istret==0) then                            !Guo
   rrmt(1 )=beta_0*(-2./6./dy)                 !Guo
   rrmt(ny)=0.                                 !Guo 
else                                           !Guo
   rrmt(1 )=beta_0*ppy(1)*(-2./6./dy)          !Guo
   rrmt(ny)=0.                                 !Guo
endif                                          !Guo
...
if (istret==0) then                         !Guo
   ddmt(1 )=0.                              !Guo
   ddmt(ny)=beta_n*(-18./6./dy)             !Guo 
else                                        !Guo
   ddmt(1 )=0.                              !Guo
   ddmt(ny)=beta_n*ppy(ny)*(-18./6./dy)     !Guo
endif                                       !Guo
...
if (istret==0) then                         !Guo
   eemt(1)=0.                               !Guo
   eemt(ny)=beta_n*(9./6./dy)               !Guo
else                                        !Guo
   eemt(1)=0.                               !Guo
   eemt(ny)=beta_n*ppy(ny)*(9./6./dy)       !Guo
endif                                       !Guo
...
if (istret==0) then                         !Guo
   qqmt(1)=0.                               !Guo
   qqmt(ny)=beta_n*(-2./6./dy)              !Guo
else                                        !Guo
   qqmt(1)=0.                               !Guo
   qqmt(ny)=beta_n*ppy(ny)*(-2./6./dy)      !Guo
endif                                       !Guo
...
!CL sur bbm11t
!bbmt11(1 )=bbmt11(1)+alsajyt/pp2y(2)            !Guo
if (istret==0) then                              !Guo
   bbmt11(1 )=bbmt11(1)+alsajyt                  !Guo
else                                             !Guo
   bbmt11(1 )=bbmt11(1)+alsajyt/pp2y(2)          !Guo
endif                                            !Guo
bbmt11(ny)=0.
...
!CL sur ddmt11
ddmt11(1 )=0.
!ddmt11(ny)=ddmt11(ny)+alsajyt/pp2y(ny-1)!a1         !Guo

if (istret==0) then                                  !Guo 
   ddmt11(ny)=ddmt11(ny)+alsajyt!a1                  !Guo
else                                                 !Guo
   ddmt11(ny)=ddmt11(ny)+alsajyt/pp2y(ny-1)!a1       !Guo
endif                                                !Guo
