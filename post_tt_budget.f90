...
!100 format(13F12.6)
  ...
  open (144,file='Aiding_flow_budget_tt.dat',form='formatted',status='unknown')
  do j=1,ny1/2
      write(144,100) yp(j),yp(j)*xl2,q_stat(j,38),q_stat(j,20),q_stat(j,50),q_stat(j,76)
   enddo
   close(144)

  open (144,file='Aiding_flow_budget2_tt.dat',form='formatted',status='unknown')
  do j=1,ny1/2
      write(144,100) ypi(j),ypi(j)*xl2,q_stat(j,69)
   enddo
   close(144)

  open (144,file='Aiding_flow_budget3_tt.dat',form='formatted',status='unknown')
  do j=1,ny1/2
...
enddo
  ...
  open (144,file='Opposing_flow_budget_tt.dat',form='formatted',status='unknown')
  do j=ny1,ny1/2+1,-1
      write(144,100) (2.0-yp(j)),(2.0-yp(j))*ABS(xl2),q_stat(j,38),q_stat(j,20),q_stat(j,50),q_stat(j,76)
   enddo
   close(144)
   
  open (144,file='Opposing_flow_budget2_tt.dat',form='formatted',status='unknown')
  do j=ny1-1,ny1/2+1,-1
      write(144,100) (2.0-ypi(j)),(2.0-ypi(j))*ABS(xl2),q_stat(j,69)
   enddo
   close(144)

  open (144,file='Opposing_flow_budget3_tt.dat',form='formatted',status='unknown')
  do j=ny1-2,ny1/2+1,-1
      write(144,100) (2.0-ypii(j)),(2.0-ypii(j))*ABS(xl2),q_stat(j,67)
   enddo
   close(144)
