...
!100 format(13F12.6)
  ...
  open (144,file='Aiding_flow_budget_uv.dat',form='formatted',status='unknown')
  do j=1,ny1/2
  ...
  open (144,file='Aiding_flow_budget3_uv.dat',form='formatted',status='unknown')
  do j=1,ny1/2
...
enddo
  ...
  open (144,file='Opposing_flow_budget_uv.dat',form='formatted',status='unknown')
  do j=ny1,ny1/2+1,-1
  ...
  open (144,file='Opposing_flow_budget3_uv.dat',form='formatted',status='unknown')
