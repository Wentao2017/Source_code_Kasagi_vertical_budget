...
ailcaix6=3./10.!0.461658                         !Guo
dicix6=0.!00293016/2.!0.                         !Guo
aicix6=1./128.*(75.+70.*ailcaix6-320.*2.*dicix6)   !Guo
bicix6=1./256.*(126.*ailcaix6-25.+1152.*2.*dicix6) !Guo
cicix6=1./256.*(-10.*ailcaix6+3.-640.*2.*dicix6)   !Guo
if (nrank==0) print *,'New coef Inter X',aicix6,bicix6,cicix6,dicix6  !Guo
cifx6(1)=ailcaix6 
cifx6(2)=ailcaix6 
...
do j=3,ny-3 
   ...
   cbi6y(j)=alcaiy6 
enddo
ailcaiy6=3./10.!0.461658                     !Guo
diciy6=0.!00293016/2.!0.                     !Guo
aiciy6=1./128.*(75.+70.*ailcaiy6-320.*2.*diciy6)    !guo
biciy6=1./256.*(126.*ailcaiy6-25.+1152.*2.*diciy6)  !Guo 
ciciy6=1./256.*(-10.*ailcaiy6+3.-640.*2.*diciy6)    !Guo
if (nrank==0) print *,'New coef Inter Y',aiciy6,biciy6,ciciy6,diciy6   !Guo
cify6(1)=ailcaiy6 
cify6(2)=ailcaiy6 
...
enddo
   ...
   do k=3,nz-3 
      ...
      cbi6z(k)=alcaiz6 
   enddo
   ailcaiz6=3./10.!0.461658                                 !Guo
   diciz6=0.!00293016/2.!0.                                 !Guo
   aiciz6=1./128.*(75.+70.*ailcaiz6-320.*2.*diciz6)         !Guo
   biciz6=1./256.*(126.*ailcaiz6-25.+1152.*2.*diciz6)       !Guo
   ciciz6=1./256.*(-10.*ailcaiz6+3.-640.*2.*diciz6)         !Guo
   if (nrank==0) print *,'New coef Inter Z',aiciz6,biciz6,ciciz6,diciz6  !Guo
   cifz6(1)=ailcaiz6 
   cifz6(2)=ailcaiz6 
...
call implicit_schemes()               !Guo
call scalar_schemes(fpi2t)            !Guo   
